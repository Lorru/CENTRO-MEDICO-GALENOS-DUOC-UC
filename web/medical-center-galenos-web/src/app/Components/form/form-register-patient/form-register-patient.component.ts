...
@Component({
    selector: 'app-form-register-patient',
    templateUrl: './form-register-patient.component.html',
    styleUrls: ['./form-register-patient.component.css'],
    providers: [
        GenderService,
        PatientService
    ]
})
export class FormRegisterPatientComponent implements OnInit {
    ...
    createPatient(){
        ...
        this._patientService.create(this.model.patientRun, this.model.patientFirstName, this.model.patientSecondName, this.model.patientSurName, this.model.patientSecondSurName, this.model.patientBirthDate, this.model.patientEmail, this.model.userPassword, this.model.genderId).subscribe(res => {
            ...
            if(res.statusCode == 201){
                ...
                modalRef.componentInstance.message = 'Se registro el paciente ' + res.patientNew.patientFullName + ' correctamente.';
